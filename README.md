A static Single Page Application (SPA) for Appventure Inc. Bootstrap CSS Framework is used as a frontend. Different plugins were used to improve user experience while navigating through the website.     
